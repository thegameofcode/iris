  ...
  */
    ...
    asyncTest("Navigate and do new navigate", function() {
        ...
        iris.on(iris.AFTER_NAVIGATION, function () {
            ...
            strictEqual(window.navigations.join(","), "[create] #,[create] #/screen1,[create] #/screen1/screen1_1,[awake] #,[awake] #/screen1,[awake] #/screen1/screen1_1", "The navigation map is correct"); // +1
        ...
        iris.on(iris.AFTER_NAVIGATION, function () {
            ...
            iris.on(iris.AFTER_NAVIGATION, function () {
                ...
                iris.on(iris.AFTER_NAVIGATION, function () {
                    ...
                    strictEqual(window.navigations.join(","), "[create] #,[awake] #,[create] #/screen1,[create] #/screen1/screen1_1,[create] #/screen1/screen1_1/screen1_1_1,[awake] #/screen1,[awake] #/screen1/screen1_1,[awake] #/screen1/screen1_1/screen1_1_1,[canSleep] #/screen1/screen1_1/screen1_1_1,[canSleep] #/screen1/screen1_1,[canSleep] #/screen1,[create] #/screen2,[sleep] #/screen1/screen1_1/screen1_1_1,[sleep] #/screen1/screen1_1,[sleep] #/screen1,[awake] #/screen2", "The navigation map is correct"); // +1

iris.Screen(function(self) {
	...
	self.Create = function() {
		...
		iris.screen.Add($library, "#library/authors",
				"example/screen/authors.js");
		...
		self.InstanceUI("btn_debug_uis", "example/ui/btn.js", {
			"onClick" : _DebugUIs,
			"label" : "Debug UI elements"
		});
	...
	function _Destroy() {
		...
		var idx = Number(self.$Get("destroy_index").val()) + 1; // Skip debug
																// button

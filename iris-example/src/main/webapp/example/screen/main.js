iris.Screen(function(self) {
	self.Create = function() {
		...
		iris.screen.Add($screens, "#example/addon-radios", "example/screen/example_addon_radios.js");
		iris.screen.Add($screens, "#example/addon-validation", "example/screen/example_addon_validation.js");
	}
});